...
# Helper function to normalize values by specific decimals
...
def save_to_csv(data, filename="WETH-USDC_Data_Debug.csv"):
    file_exists = False
    try:
...
def main():
    ...
    pool_id = "0x04d24dbdd9ea6e8af5b5eb0126797da27498df1d"
    
    start_timestamp = int(datetime(2024, 4, 2, 4, 3, 22).timestamp())
    ...
    while current_timestamp <= today_timestamp:
        ...
        if pool_data:
            ...
            save_to_csv(csv_row, "WETH-USDC_Data.csv")
